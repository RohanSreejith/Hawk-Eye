...
class HawkEngine:
    ...
    SCENARIO_VIDEOS = {
        ...
        # step 3 - VEHICLE_INBOUND broadcast
        3: {
            "camera_a": "nearmiss-rgb-00000/001e53453441935632ae_run_1_seed_1288693302.ceiling_00.rgb.mp4",
            "camera_b": "nearmiss-rgb-00000/001e53453441935632ae_run_1_seed_1288693302.ceiling_01.rgb.mp4",
        },
    ...
    def get_state(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if active_pair and step in [1, 2, 3, 4, 5]:
                ...
                if step == 1:
                    ...
                    # Anticipate mode (Steps 2, 3, 4): Proactive Warning for Inbound Vehicle from Agent A!
    ...
    async def run_scenario_step(self, step: int):
        ...
        if step == 1:
            ...
            self.active_events = [{
                ...
                "from_camera": "Camera A (Corridor)",
                "target_zone": "B (Loading Area)",
                "time": now,
                "status": "active"
            }]
            self.warehouse_zones["transit_progress"] = 0.45
            self.add_event_stream_message("Agent A", "→ Published VEHICLE_INBOUND to Shared State (Target: Zone B)", "#00f2fe")
            self.add_event_stream_message("Shared State", "Routing V01 trajectory through Transit Corridor to Zone B", "#f59e0b")
